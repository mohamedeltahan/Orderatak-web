...
<div class="d-none temp_icons"  >
    <i class="fab fa-facebook fa-2x facebook  فيسبوك"> </i>
    <i class="fab fa-twitter fa-2x  twitter تويتر" > </i>
    <i class="fab fa-instagram fa-2x instagram انستجرام" style="color: red"> </i>
    <i class="جوميا jumia">jumia  </i>
    <i class="سوق souq"> souq </i>
    <i class="اخري other" > other</i>
</div>
    ...
    <div class="hidden_phone row" style="width: 100%; display: none" id="hidden_phone">
       <div class="col">
        <div class="input-group mb-2 mr-sm-2">
            ...
            <input  name="phone[]" type="number" class="form-control" placeholder="ادخل رقم العميل">
        </div>
       </div>
    </div>
...
<!--End side menu component-->
    ...
    <!---end of navbar !-->
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            <thead >
            <tr >
                <th style="background: #5C71A3; color: white;" >الاسم</th>
                <th style="background: #5C71A3; color: white;">رقم التليفون</th>
                <th style="background: #5C71A3; color: white;">المنصة</th>
                <th style="background: #5C71A3; color: white;">المحافظة</th>
                <th style="background: #5C71A3; color: white;">العنوان</th>
                <th style="background: #5C71A3; color: white;">الحالة</th>
            ...
            @foreach($customers as $customer)
                ...
                <td class="phone" style="border-left: 1px solid rgba(34,36,38,.1);">
                ...
                <td class="customer_platform" data-platform_name="{{$customer->customer_platform}}">   
                     <a href="{{$customer->customer_link}}" target="_blank"> <span>
                  @if($customer->customer_platform==="فيسبوك"|| $customer->customer_platform==="facebook")
                  <i class="fab fa-facebook fa-2x"> </i>
                  @elseif($customer->customer_platform=="انستجرام" || $customer->customer_platform==="instagram")
                  <i class="fab fa-instagram fa-2x" style="color: red"> </i>
                  @elseif($customer->customer_platform=="تويتر" || $customer->customer_platform==="twitter")
                            ...
                            <div class=" row" style="width: 100%">
                                <div class="col">
                                    ...
                                    <select  name="customer_platform" type="text" id="customer_platform"  class="form-control all">
                                        <option value="" >اختر  منصة العميل</option>
                                        <option data-holder="ادخل لينك الفيسبوك" value="facebook"> فيس بوك</option>
                                        <option data-holder="ادخل لينك انستجرام" value="instagram">انستجرام</option>
                                        <option data-holder="ادخل لينك تويتر" value="twitter">تويتر</option>
                                        <option data-holder="ادخل لينك جوميا" value="jumia">جوميا</option>
                                        <option data-holder="ادخل لينك سوق" value="souq">سوق</option>
                                        <option data-holder="ادخل لينك العميل" value="other">اخري</option>
                            ...
                            <div class="row" style="width: 100%">
                             <div class="col">
                                 <div class="input-group mb-2 mr-sm-2">
                                     ...
                                     <input name="phone[]"  id="phone" type="number" class="form-control all" placeholder="ادخل رقم الهاتف">
                                </div>
                              </div>
                            </div>

                            <div class="form-group row last_phone " style="width: 100%">
...
<table style="display: none">
    ...
    <tr id="temp_customer_row" style="font-weight: 500" class="customers_row">
        <td class="name" style="border-left: 1px solid rgba(34,36,38,.1);"><a target="_blank" href="{{route("customers.show","X")}}"></a></td>
        <td class="phone">
            <select style="border: none;font-weight: 500;background: none">

            </select>
        </td>
        <td class="customer_platform">   
            <a href="" target="_blank" data-platform_name=""> <span>
...
<script >
    ...
    $(document).ready(function() {
     ...
     t=$('#example').DataTable({
        ...
        var x=$("<button id='load_more'  style='position: absolute;right: 50%;background: #5C71A3;border: none;border-radius: 1.24rem;' class='btn btn-primary'>عرض المزيد</button>");
        temp.html(x);
    ...
    $(document).on("click",".fa-user-edit",function () {
        var customer_id=$(this).parent().parent().attr("data-id");
       ...
       // $("#address").val(table.find(".address").find("option:selected").val());
        ...
        $("#customer_platform").val(table.find(".customer_platform").attr("data-platform_name"));
        $("#customer_link").val(table.find(".customer_platform a").attr("href"));
            ...
            if ($.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        tr.find(".customer_platform a").attr("href",result[i].customer_link);
                        tr.find(".customer_platform a").attr("data-platform_name",result[i].customer_platform);
                        
               
                        tr.find(".customer_platform a span").html($(".temp_icons").find("."+result[i].customer_platform).clone());
    ...
    $(document).on("click",".reset_search",function (e) {
            $("#example_filter #search_option").val("none");
            $("#search").val("");
            $("#example_filter #search_option").trigger("change");
    ...
    $(".add_another_phone").click(function () {
        ...
        // $("#phone").val($(this).text());
        $(".modal-body form .last_phone ").before(temp);
    });
