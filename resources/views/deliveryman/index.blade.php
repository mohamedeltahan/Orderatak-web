...
<!--End side menu component-->
    ...
    <!---end of navbar !-->
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            <thead >
            <tr >
                <th style="background: #5C71A3; color: white;" >المندوب</th>
...
<script >
    $(document).ready(function() {
       ...
       /* var temp=$(".grid .row:last");
        ...
        x=$("<button id='modal_button' data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: #5C71A3;border-radius: 1.24rem;'><i class='fas fa-shipping-fast fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة مندوب شحن</span></i></button>");
