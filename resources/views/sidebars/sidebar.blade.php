    ...
    <div class="p-4 pt-5">
        ...
        <div class="user-info">
            <div class="user-img-container">
                <img style="width: 100%" src="{{asset("imges/one-x.png")}}" alt="user">
                <span></span>
            </div>
        </div>
        ...
        <h3 style="margin-left: 15px;">+201013917487 <i class="fas fa-phone-alt"></i></h3>
        <h4 style="">sales@orderatak.com</h4>
