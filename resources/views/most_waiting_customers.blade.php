            ...
            <div class="data-container">
                <table id="example" class="ui celled table" style="width:100%;text-align: center;font-weight: 500" dir="rtl" >
                    ...
                    <tr>
                        ...
                        <th style="background: #5C71A3; color: white;">عدد ايام الانتظار</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($static_array as $name=>$value)
                        ...
                        <tr  class="customer">
                            <td style="border-left: 1px solid rgba(34,36,38,.1);"  ><a class="name" href="{{route("customers.show",$name)}}">{{\App\Customer::where("name",$name)->first()->name}}</a> </td>
        ...
        <script >
            window.onload = function () {
                ...
                var chart = new CanvasJS.Chart("heights-clients-chartContainer", {
                    ...
                    title: {
                        text: "العملاء الاكثر انتظارا"
                    },
                    axisY: {
                        title: "عدد ايام الانتظار",
                        suffix: "",
                        includeZero: false
                    },
                    axisX: {
                    ...
                    data: [{
                        ...
                        dataPoints: [
                            ...
                            { label: username[5], y: uservalues[5] },
                            { label: username[6], y: uservalues[6] },
