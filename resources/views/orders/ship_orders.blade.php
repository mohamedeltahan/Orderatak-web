...
<div class="hidden_district row" style="width: 100%; display: none" id="hidden_district">
        <div class="col">
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <select  name="districts[]" type="text" class="form-control districts_input" >
        ...
        <div class="col">
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <input name="cost[]" type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control districts_input"  placeholder="تكلفة الشحن للمنطقة">
            </div>
...
<!--End side menu component-->
    ...
    <nav style="margin-right: 1%">
      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active " id="ship-details" role="tabpanel" aria-labelledby="nav-home-tab">
            <table class="table table-bordered table-striped" style="background: white; width:90%; margin-right: 5%; margin-top:5%">
                <tbody>
                <tr>
        ...
        <div class="tab-pane fade" id="ship-orders" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="exporters-main-container col-12" style="">
                <div class="exports_cases" style="width: 80%; margin-top: 55px; margin-right: 23%" >
                ...
                <table id="example" dir="ltr" class="ui celled table table-fixed" style="text-align: center" dir="rtl"   >
                    ...
                    <tr class="firstrow">
                        ...
                        <th style="background: #5C71A3; color: white; width:160px;">حالة</th>
                        <th  style="background: #5C71A3; color: white;">اصناف</th>
                        <th style="background: #5C71A3; color: white;">السعر</th>
                        <th style="background: #5C71A3; color: white;">البوليصة</th>
                        <th  style="background: #5C71A3; color: white;">رقم الفاتورة</th>
                    </tr>
                ...
                <tr id="{{$order->id}}"  style="font-weight: 700">
                    <td class="first_td">
                        ...
                        @else
                        <button class="btn btn-primary collect" style="background-color: blue; border-color: blue; font-weight: 700;"  > تحصيل</button></td>
                        @endif
                    <td>{{$order->user->name}}</td>
                    <td data-id="{{$order->id}}">           
                         <select name="state" id="state" class="form-control state" style="font-weight: 700">
        
                        <option value="" >احتر حالة الفواتير</option>
                        <option @if($order->state=="انتظار") selected @endif value="انتظار">انتظار</option>
                        <option @if($order->state=="لم يتم التاكيد") selected @endif value="لم يتم التاكيد">لم يتم التاكيد</option>


                        <option @if($order->state=="تم التاكيد") selected @endif value="تم التاكيد"> تم التاكيد</option>
                        <option @if($order->state=="تم التسليم لشركة الشحن") selected @endif value="تم التسليم لشركة الشحن" >تم التسليم لشركة الشحن</option>

                        <option @if($order->state=="تم الشحن") selected @endif value="تم الشحن">تم الشحن </option>
                        <option @if($order->state=="مرتجع جزئي") disabled selected @endif value="مرتجع جزئي"> مرتجع جزئي</option>

                        <option @if($order->state=="مرتجع")  selected @endif value="مرتجع"> مرتجع</option>

                    </select>  
                    </td>
                    <td class="itemsinorder count">{{$order->items()->count()}}</td>
                    <td>{{$order->total_price_after_discount}}</td>
                    <td>{{$order->policy_id}}</td>
                    <td class="number"><a style="font-weight: 700" target="_blank" class="link" href="{{route("order_to_pdf",$order->id)}}">{{$order->id}}</a></td>
        ...
        <div class="tab-pane fade " id="ship-payments" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="cases first_case" style="width: 33%;">
                    <div class="cards" >
                        ...
                        <div class="card-body" style="display: flex; padding: 0px">
                            <div style="width: 29%;height: 100%;margin-top: 9px;"><i  style="color: #14577e;" class="fas fa-boxes fa-3x"></i></div>
    
                            <a  style="width: 71%;height: 100%;padding: 12px 9px; display: inline-grid;"href="{{route("orders_with_state","تم التسليم لشركة الشحن")}}?ship_id={{$ship_id}}" class="btn " >
                                <span style="font-weight: bold">{{$orders_with_the_ship}}</span>
                                <span style="font-weight: 900;font-size: 20px;color: #14577e;">  اوردرات تم تسليمها </span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="cases first_case" style="width: 33%;">
                    <div class="cards"  style="">
                        ...
                        <div class="card-body" style="display: flex; padding: 0px;" >
                            ...
                            <a  style="width: 100%;height: 100%;padding: 12px 9px; display: inline-grid;" href="{{route("orders_with_state","تم الشحن")}}?ship_id={{$ship_id}}" class="btn " >
                                <span style="font-weight: bold">{{$orders_delivered_with_the_ship}}</span>
                                <span style="font-weight: 900;font-size: 20px;color: #72b1ff;"> اوردرات تم شحنها</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="cases first_case" style="width: 33%;">
                    <div class="cards" >
                        ...
                        <div class="card-body" style="display: flex; padding: 0px">
                            ...
                            <a  style="width: 71%;height: 100%;padding: 12px 9px; display: inline-grid;" href="{{route("restoreds.index",["ship_id"=>$ship->id])}}" class="btn " >
                                <span style="font-weight: bold">{{$orders_restoreds_with_the_ship}}</span>
            ...
            <div class="exports_cases" style="width: 80%; display: inline-flex; margin-left: 10%" >
                <div class="cases first_case" style="width: 33%;">
                    <div class="cards" >
                        ...
                        <div class="card-body" style="display: flex; padding: 0px">
                            <div style="width: 29%;height: 100%;margin-top: 9px;"><i style="color: #00dd00;" class="fas fa-dollar-sign fa-3x"></i></div>
    
                            <a  style="width: 71%;height: 100%;padding: 12px 9px; display: inline-grid; "href="#" class="btn " >
                                <span style="font-weight: bold">{{$money_with_the_ship}}</span>
                                <span style="font-weight: 900;font-size: 20px; color: #00dd00;">اجمالي المبلغ المستحق</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="cases first_case" style="width: 33%;">
                    <div class="cards" >
                        ...
                        <div class="card-body" style="display: flex; padding: 0px">
                            <div style="width: 29%;height: 100%;margin-top: 9px;"><i style="color: #00c7d0;" class="fas fa-hand-holding-usd fa-3x"></i></div>
    
                            <a  style="width: 71%;height: 100%;padding: 12px 9px; display: inline-grid; "href="#" class="btn " >
                                <span style="font-weight: bold">{{$money_paid_with_the_ship}}</span>
                                <span style="font-weight: 900;font-size: 20px; color: #00c7d0;">اجمالي ما تم تحصيله</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="cases first_case" style="width: 33%;">
                    <div class="cards" >
                        ...
                        <div class="card-body" style="display: flex; padding: 0px">
                            <div style="width: 29%;height: 100%;margin-top: 9px;"><i  style="color: blue;" class="fas fa-search-dollar fa-3x"></i></div>
    
                            <a  style="width: 71%;height: 100%;padding: 12px 9px; display: inline-grid;"href="#" class="btn " >
                                <span style="font-weight: bold">{{$money_with_the_ship-$money_paid_with_the_ship}}</span>
                                <span style="font-weight: 900;font-size: 20px ;color: blue;">اجمالي المبلغ المتبقي</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <table id="payments" class="ui celled table" style="text-align: center" dir="rtl"    >
                <thead >
                <tr >
                ...
                <tbody> 
              @foreach (\App\Ship::find($ship_id)->payments as $payment)
                <tr>
    
                    <td style="font-weight: 500; border-left:1px solid rgba(34,36,38,.1); ">{{$payment->date}}</td>
                    <td style="font-weight: 500;">{{$payment->description}}</td>
                    <td style="font-weight: 500;">{{$payment->method}}</td>
                    <td style="background-color: aqua; font-weight: 700">{{$payment->amount}}</td>
                </tr>
                @endforeach
        ...
        <div class="tab-pane fade " id="ship-districts" role="tabpanel" aria-labelledby="nav-home-tab">
            <table id="districts" class="ui celled table" style="text-align: center" dir="rtl"    >
                ...
                <tr >
                    ...
                    <th style="background: #5C71A3; color: white;">المبلغ</th>
                ...
                <tbody> 
              @foreach (\App\Ship::find($ship_id)->shipdistricts as $shipdistrict)
                <tr>
    
                    <form method="post" action="{{route("ship-districts.update",$shipdistrict->id)}}">
                        @csrf
                        @method("put")
                        <td class="name">  <span> {{$shipdistrict->district->name}} </span> </td>
                        <td class="cost">  <input name="cost" type="number" min="0" onkeypress="return event.charCode >= 48" value="{{$shipdistrict->cost}}"></td>

                        <td><button type="button" class="transparent_button update_circle" ><i class="fas fa-check-circle"></i></button>
                             <button type="submit" class="update_submit d-none"></button>
                        </td>
                    ...
                    <td>
                        ...
                        <form  class="d-none" method="post" action="{{route("ship-districts.destroy",$shipdistrict->id)}}">
                            @csrf
                            @method("DELETE")
                            <button class="transparent_button"><i class="fas fa-trash-alt delete_button"></i></button>
                        </form></td>
                </tr>
                @endforeach
      ...
      <!-- Modal -->
      <div class="modal fade" id="districtsModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  >
          <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 45%">
              <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                  <div class="modal-header" dir="ltr">
                      <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 37%;margin-top: 6%"> <i class="fas fa-map-marked-alt fa-2x" style="padding-left: 10px"></i> <span>اضافة منطقة شحن </span> </h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true" style="font-size: 30px">&times;</span>
                      </button>
                  </div>
                  <div class="modal-body" style="height: auto">
                    <form action="{{route("ship-districts.store")}}" method="post" class="districts_form">
                        @csrf
                        <input name="ship_id" value="{{$ship_id}}" class="d-none" >
                        <div class="row" style="width: 100%">
                            <div class="col">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <select  name="districts[]" type="text" class="form-control all" >
                                         <option value="0">اختر المنطقة </option>
                            ...
                            <div class="col">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input name="cost[]" type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control all"  placeholder="تكلفة الشحن للمنطقة">
                                </div>
                        ...
                        <div class="row last" style="width: 100%">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary submit d-none" >اضافة</button>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 75%">
                    <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                        <div class="modal-header" dir="ltr" style="">
                            <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 43%;margin-top: 6%"><i class="fas fa-file-invoice fa-2x" style="padding-left: 10px"></i>تفاصيل الاوردر  </h5>
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                    <div class="modal-header" dir="ltr">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 37%;margin-top: 6%"><i class="fas fa-hand-holding-usd fa-2x" style="padding-right: 10px"></i> تحصيل مبلغ    </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true" style="font-size: 30px">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" style="height: auto">
                        <form id="form" method="post" action="{{route("ship-payments.store","")}}" class="payments_form">
                            @csrf
                            <input name="ship_id" value="{{$ship_id}}" class="d-none">
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text" style="font-weight: 700"> المبلغ </div>
                                    </div>
                                    <input dir="rtl" type="number"  id="amount"   name="amount" class="form-control all-payment" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            <div class="form-group row" style="width: 100%">
                                <label class="sr-only" >Username</label>
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input dir="rtl" type="date"  id="date"  name="date" class="form-control all-payment" aria-describedby="basic-addon1">
                            ...
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text" style="font-weight: 700">وسيلة الدفع</div>
                                    </div>
                                    <input dir="rtl" type="text" id="method"  name="method" class="form-control all-payment" aria-describedby="basic-addon1">
                            ...
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text" style="font-weight: 700">البيان</div>
                                    </div>
                                    <input dir="rtl" type="text" id="description"  name="description" class="form-control all-payment" aria-describedby="basic-addon1">
                            ...
                            <div class="modal-footer">
                                <button  type="button" class="btn btn-danger " data-dismiss="modal" style="position: absolute;right: 11px">الغاء</button>
                                <button id="submit_button" type="submit" class="btn btn-primary submit d-none" >اضافة</button>
                                <button type="button" class="btn btn-primary validate_and_submit" >اضافة</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                ...
                <div class="modal-body" style="height: auto;    font-weight: bold;text-align: center;padding: 38px;">
                   هل تريد حذف المنطقة من تغطية الشركة ؟
                </div>
                <div class="modal-footer">
...
$(document).on("click",".add_another_district",function () {
    ...
    $(temp).find(".districts_input").addClass("all");
    temp.css("display","");
    temp.attr("id","");
...
function null_input(input) {
  ...
  $(document).on("click",".districts_form .validate_and_submit",function(){
    ...
    $(document).on("click",".payments_form .validate_and_submit",function(){
       
    if( validate(["all-payment"],[["null_input"]])){
       $(this).parent().find(".submit").click();
   }
   else{
       alert("من فضلك راجع الخانات باللون الاحمر");
   ...
   $(".update_circle").click(function(){
       var temp=$(this).parent().parent().find(".cost").find("input");
       if(temp.val().length===0){
           alert("من فضلك ادخل تكلفة الشحن لهذه المنطقة");
       }
       else{
           $(this).parent().find(".update_submit").click();
       }
