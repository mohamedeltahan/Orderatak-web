                        ...
                        <form autocomplete="off" id="receiptclientinfoform" >
                            ...
                            <select  type="text" id="customer_platform"   class=" rdev all" style="font-size:17px;">
                             ...
                             <input class="defv"  value="{{$customer->customer_link}}" type="text" placeholder="لينك العميل" id="customer_link" name="customer_link">
                                ...
                                <input type="number" name="restored_quantity"  data-quantity="{{$order_item->quantity}}" placeholder="الكمية المستبدلة" id="restored_quantity" style="float:right; margin-top:5px" class="all"  >
                                                 
                                                                <input type="text" placeholder="ملاحظة" id=""  class="defv note">

                                <select   id="received"  class="defv" style="float: left;     border: 0;
    border-bottom: solid 1px #5C71A3;
    ...
    text-align: right; height: 41px; ">         <option value="0">لم يتم اللاستلام من شركة الشحن بعد</option>
                    ...
                    <div class="orderscontainer" id="ordercontainer">
                        ...
                        <form style="display: none" id="hiddenform" method="post" action="{{route("replacement")}}">
                            ...
                            <input id="store_id_in_hidden_form" name="store_id" value="{{App\Store::first()->id}}">
                    ...
                    <div class="receipt" style="font-size:20px; margin-top:60px">
...
<div class="add-popup-container d-none">
...
$(document).on("change","#stores_list",function () {
        ...
        $("#store_id_in_hidden_form").attr("value",val);
    });
