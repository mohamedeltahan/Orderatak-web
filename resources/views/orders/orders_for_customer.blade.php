...
<input id="get_district_cost_url" class="d-none" value="{{route("get_district_cost","")}}">
...
<input class="url" value="{{route("get_order_for_customer",$customer_id)}}" style="display: none">
    ...
    <!--End side menu component-->
        ...
        <div style="width: 82%" id="main_div">
            ...
            @section('content')
                ...
                <li class="breadcrumb-item" ><a href=""> اوردرات عميل </a></li>
        ...
        <nav style="margin-right: 1%">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <a class="nav-item  nav-link active" id="customer-details-tab" data-toggle="tab" href="#customer-details" role="tab" aria-controls="nav-home" aria-selected="true">تفاصيل العميل</a>
              <a class="nav-item  nav-link" id="customer-orders-tab" data-toggle="tab" href="#customer-orders" role="tab" aria-controls="nav-profile" aria-selected="false">اوردرات العميل</a>
              <a class="nav-item  nav-link" id="customer-issues-tab" data-toggle="tab" href="#customer-issues" role="tab" aria-controls="nav-contact" aria-selected="false">شكاوي العميل</a>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="customer-details" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="exporters-main-container col-12 " style="">
                    <table class="table table-bordered table-striped" style="background: white; width:90%; margin-right: 5%; margin-top:5%">
                        ...
                        <tr>
                            ...
                            <td><select style="background: none">
            ...
            <div class="tab-pane fade" id="customer-orders" role="tabpanel" aria-labelledby="nav-profile-tab">
            ...
            <div class="tab-pane fade" id="customer-issues" role="tabpanel" aria-labelledby="nav-contact-tab">...</div>
          </div>
                    ...
                    <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                        ...
                        <div class="modal-body" style="height: auto">
                            <nav class="nav-fill nav_head" >
                              ...
                              <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane second_tabe fade show active" id="nav-order" role="tabpanel" aria-labelledby="nav-order-tab">
                                ...
                                <div class="tab-pane second_tabe fade" id="nav-customer" role="tabpanel" aria-labelledby="nav-customer-tab" style="padding: 35px" >
                                ...
                                <div class="tab-pane second_tabe fade" id="nav-items" role="tabpanel" aria-labelledby="nav-items-tab" style="padding:25px">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                    <div class="modal-header" dir="ltr">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 37%;margin-top: 6%"><i class="fas fa-undo fa-2x" style="padding-right: 10px"></i> تسجيل مرتجع  </h5>
                            ...
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <select dir="rtl"   name="received" class="form-control" aria-describedby="basic-addon1">
                                        <option value="0">لم يتم الاستلام من شركة الشحن بعد</option>
...
<table  style="display: none">
 <tr id="temp" class="orderdetails noborderright">
    ...
    <td class="co-1 delivery_man hovered" data-id=""><select class="shippers" style="border: none;background: transparent; font-weight: 700">
    ...
    <td class="co-1 hovered"  data-id=""><select class="companies" style="border: none;background: transparent; font-weight: 700">
...
<table id="last" style="display: none">
    <tr>
        ...
        <td class="co-1 replace nested_hovered" data-id="" ><a class="replace_link" style="border: none" href="{{route("replacement_create","X")}}">استبدال</a></td>
...
<script>
    ...
    $("body").on("click",".number",function() {
        ...
        function add_item(){
           ...
           if((result[i].state=="تم التسليم لشركة الشحن")|| (result[i].state=="تم الشحن")){
             ...
             tr.find(".replace_link").attr("href",tr.find(".replace_link").attr("href").replace("X",result[i].id));
                ...
                tr.find(".restore").addClass("not_delivered_to_company");
                tr.find(".replace").addClass("not_delivered_to_company");
                tr.find(".restore").removeClass("restore");
                tr.find(".replace").removeClass("replace");
                tr.find(".replace_link").attr("href","#");
...
$("#order_modal").on("hidden.bs.modal",function(){
    ...
    $(".second_tabe").removeClass("active");
    $(".second_tabe").removeClass("show");
    $(".my_navs").first().addClass("active");
    $(".second_tabe").first().addClass("active");
    $(".second_tabe").first().addClass("show");
