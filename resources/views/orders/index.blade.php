                                            ...
                                            <div class="month co-2">
                                                ...
                                                <div class="orderstable toggeltable">
                                                    <table id="example" class="maintable" dir="ltr" style="font-weight: 700">
                                                        <tr class="firstrow cannot_be_colored">
                              ...
                              <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="row" style="width: 100%">
                                            <div class="col">
                                                ...
                                                <div class="input-group mb-2 mr-sm-2">
                                                    ...
                                                    <input disabled data-old_value=""  name="total_price_after_discount" id="total_price_after_discount" type="text" class="form-control" >
                                                </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="input-group mb-2 mr-sm-2">
                                                    ...
                                                    <input  name="delivery"  id="delivery" type="number" class="form-control" >
                                                </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="input-group mb-2 mr-sm-2">
                                                    ...
                                                    <input data-old_value=""  name="discount" id="discount" type="number" class="form-control" >
                                                </div>
                                ...
                                <div class="tab-pane fade" id="nav-customer" role="tabpanel" aria-labelledby="nav-customer-tab" style="padding: 35px" >
                                    ...
                                    <table class="table table-striped table-bordered " style="background: white; width:100%; margin-right: 0" >
                                        <tbody>
                                        <tr class="name_row cannot_be_colored">
                                            <th scope="row">الاسم</th>
                                            <td class="customer_name"></td>
                    
                                        </tr>
                                        <tr id="phone_row" class="cannot_be_colored">
                                            <th scope="row" >رقم الهاتف</th>
                                            <td class="customer_phone"></td>
                                        </tr>
                                        <tr class="cannot_be_colored">
                                            <th scope="row"> المحافظة</th>
                    
                                            <td class="customer_governorate"> </td>
                                        </tr>
                                        <tr id="address_row" class="cannot_be_colored">
                                            <th scope="row">العنوان</th>
                                            <td class="customer_address"></td>
                                        </tr>
                                        <tr class="cannot_be_colored">
                                            <th scope="row">لينك العميل</th>
                    
                                            <td class="customer_link"></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="tab-pane fade" id="nav-items" role="tabpanel" aria-labelledby="nav-items-tab" style="padding:25px">
                                    <table class="table table-bordered" id="modal_items_table" dir="rtl" style="background: white; width:100%; margin-right: 0">
                                        <tbody>
                                        <tr class="headrow cannot_be_colored" style="background-color: #5C71A3" >
    ...
    $("body").on("click",".number",function() {
            ...
            if ($.ajax({
                ...
                success: function (r) {
                    ...
                    $("#state").val(r.state);
                    $("#district").attr("data-shipper_id",r.ship_id);
                    $("#district").val(r.district_id);
                    $("#ship").val(r.ship);
                    $("#delivery").val(r.delivery);
                    $("#total_price_after_discount").val(r.total_price_after_discount);
                     $("#total_price_after_discount").attr("data-old_value",r.total_price_after_discount);

                    $("#discount").val(r.discount);
                    $("#discount").attr("data-old_value",parseInt(r.discount)); 
                    ...
                    $(".customer_address").text(addresses.substring(0, addresses.length - 2));
                        ...
                        $(".customer_link").text(r.customer.customer_link);
        ...
        $("body").on("click","td",function(){
              ...
              if(!$(this).parent().hasClass("cannot_be_colored")){
...
$(document).on("change","#district",function(){
    ...
    var url =$("#get_district_cost_url").val()+"/"+$(this).val()+"?shipper_id="+$(this).attr("data-shipper_id");
...
$(document).on("keyup","#discount",function(e){
    ...
    if($("#discount").val().length===0){
            $("#total_price_after_discount").val(parseInt($("#total_price_after_discount").attr("data-old_value"))+parseInt($("#discount").attr("data-old_value")));

        return;
    }
    $("#total_price_after_discount").val(parseInt($("#total_price_after_discount").attr("data-old_value"))+parseInt($("#discount").attr("data-old_value")-parseInt($("#discount").val())));
})
