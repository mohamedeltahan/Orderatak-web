...
<!--End side menu component-->
    ...
    <!---end of navbar !-->
        ...
        <div style="height:70px; width: 80%; background-color: white; margin-right: 10%; border-radius: 1.24rem">
            <div style="position: absolute; margin-top:14px; margin-right:15px;">
                <i style="color: darkgreen;" class="fas fa-money-check-alt fa-2x">
                    <span style="padding-right:10px">فلتر الاوردرات </span>
                     </i>
            </div>
            <button id="add_item_button" class="btn btn-success" style="width: 100px;height: 40px; border-radius: 1.24rem; margin-left:15px; margin-top:14px;"> فلتر النتائج</button>
            ...
            <form style="display: block;font-weight: 500">
                <div class="line" style="display: flex;width: 90%">
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 57%;"> اسم العميل:</label>
                        <input  style="border: 1px solid cadetblue;border-radius: 10px;width: 80%; height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 57%;" >رقم العميل:</label>
                        <input style="border: 1px solid cadetblue;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 57%;"> مندوب الشحن:</label>
                        <select style="border: 1px solid cadetblue;border-radius: 10px;width: 80%;height: 35px;" >
                            <option value="">اختر مندوب</option>
                            @foreach(App\Ship::all() as $ship)
                ...
                <div class="line" style="display: flex;width: 90%">
                    ...
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 67%;"> من :</label>
                        <input style="border: 1px solid cadetblue;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 67%;"> الي :</label>
                        <input style="border: 1px solid cadetblue;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 57%;"> حالة الاوردر :</label>
                        
                                <select name="state" style="border: 1px solid cadetblue;border-radius: 10px;width: 80%;height: 35px;">

                                    <option value="" >اختر حالة الفواتير</option>
        ...
        <table id="example" class="ui celled table table-fixed" style="text-align: center" dir="rtl"   >
            ...
            <th style="background: #5C71A3; color: white;" >رقم</th>
            <th style="background: #5C71A3; color: white;">اسم الصفحة</th>
            <th style="background: #5C71A3; color: white;">اكونت العميل</th>
            <th style="background: #5C71A3; color: white;">اسم العميل</th>
            <th style="background: #5C71A3; color: white;">تليفون العميل</th>
            <th style="background: #5C71A3; color: white;"> المحافظة</th>
            <th style="background: #5C71A3; color: white;"> العنوان</th>
            <th style="background: #5C71A3; color: white;">محتويات الاوردر</th>
            <th style="background: #5C71A3; color: white;">الشحن</th>

            <th style="background: #5C71A3; color: white;">سعر الشحن</th>
            <th style="background: #5C71A3; color: white;">اسم المندوب</th>
            <th style="background: #5C71A3; color: white;">اكونت المندوب</th>
            <th style="background: #5C71A3; color: white;">تليفون المندوب</th>
            <th style="background: #5C71A3; color: white;"> ملاحظات</th>
