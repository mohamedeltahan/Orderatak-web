    ...
    <div class="roles" style="height: 30%; margin-top: 50px;" >
        <div class="rol">
            <ul style="text-align: right; list-style: none; width: 70%; float: right; font-weight: bold;">
                <li>شكرا لتواصلكم معنا </li>
                <li>يمكن استبدال او استرجاع المنتج فى حالة عدم ثبوت فاعليته بعد اتباع طريقة الاستخدام المحدده وتجربة المنتج اكثر من مره فى خلال 7 ايام من تاريخ الاستلام</li>
                 <li>منتجات العطار الحديثه <br> 01145500112</li>
