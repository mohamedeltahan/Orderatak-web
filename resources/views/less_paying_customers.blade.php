        ...
        <div class="reports-container">
            ...
            <div class="clients-reports report" id="clients-reports">
                ...
                <div class="data-container">
                    <table id="example" class="ui celled table" style="width:100%;font-weight: 500;text-align: center" dir="rtl" >
                        <thead>
                        <tr>
                            <th style="background: #5C71A3; color: white;">الاسم</th>
                            <th style="background: #5C71A3; color: white;">عدد الاوردرات</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($static_array as $name=>$value)
                            ...
                            <tr  class="customer">
                                <td style="border-left: 1px solid rgba(34,36,38,.1);"  > <a class="name" href="{{route("customers.show",$name)}}">{{\App\Customer::find($name)->name}}</a></td>
