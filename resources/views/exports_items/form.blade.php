...
<div class="form-group{{ $errors->has('buying_price') ? 'has-error' : ''}}">
    ...
    {!! Form::text('buying_price', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('selling_price') ? 'has-error' : ''}}">
    ...
    {!! Form::text('selling_price', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('export_id') ? 'has-error' : ''}}">
    ...
    {!! Form::text('export_id', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
