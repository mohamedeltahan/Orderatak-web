...
<!--End side menu component-->
    ...
    <div class="form-group row" style="width: 100%">
        ...
        <table id="example" class="ui celled table table-fixed" style="text-align: center" dir="rtl"   >
            ...
            <th style="background: lightseagreen; color: white;">سعر البيع</th>
            <th style="background: lightseagreen; color: white;"> اجمالي المبلغ</th>
            <th style="background: lightseagreen; color: white;">اهلاك</th>
