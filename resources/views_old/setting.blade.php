    ...
    <!---end of navbar !-->
        ...
        <table id="users" class="ui celled table" style="text-align: center" dir="rtl"   >
            ...
            <tr >
                ...
                <th style="background: lightseagreen; color: white;" >رقم الهاتف</th>
                <th style="background: lightseagreen; color: white;">الصلاحيات </th>
                <th style="background: lightseagreen; color: white;">كلمة السر</th>
        ...
        <table id="items" class="ui celled table" style="text-align: center" dir="rtl"   >
            <thead >
            <tr >
                <th style="background: lightseagreen; color: white;" >كود</th>
                <th style="background: lightseagreen; color: white;">صنف</th>
                <th style="background: lightseagreen; color: white;">لون</th>
                <th style="background: lightseagreen; color: white;">حفظ</th>
                <th style="background: lightseagreen; color: white;">حذف</th>
        ...
        <table id="stores" class="ui celled table" style="text-align: center;" dir="rtl"   >
            ...
            <tr >
                ...
                <th style="background: lightseagreen; color: white;" >اسم</th>
                <th style="background: lightseagreen; color: white;" >عنوان</th>
                <th style="background: lightseagreen; color: white;" >رقم هاتف</th>
...
$(document).on("click",".paginate_button", function() {
    $('.selectpicker').selectpicker('refresh');
        ...
        var x1=$("<button id='users_modal_button'    data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-user-plus fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة مستخدم</span></i></button>");
        var x3=$("<button id='districts_modal_button'   data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-map-marked-alt fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة منطقة شحن</span></i></button>");
        var x4=$("<button id='items_modal_button'   data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-boxes fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة صنف</span></i></button>");
        var x5=$("<button id='stores_modal_button'   data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-store fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة مخزن</span></i></button>");
