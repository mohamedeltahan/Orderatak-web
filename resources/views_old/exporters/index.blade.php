    ...
    <!---end of navbar !-->
                ...
                <div class="cards" >
                    ...
                    <div class="card-body" style="display: flex; padding: 0px">
                        ...
                        <a  style="width: 71%;height: 100%;padding: 12px 9px; display: inline-grid;"href="#" class="btn " >
                            ...
                            <span style="font-weight: 900;font-size: 20px">جمالي مشتريات</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            ...
            <tr >
                ...
                <th style="background: lightseagreen; color: white;">التفاصيل</th>
...
<script >
    $(document).ready(function() {
        ...
        x=$("<button id='modal_button' data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-user-plus fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة مورد</span></i></button>");
