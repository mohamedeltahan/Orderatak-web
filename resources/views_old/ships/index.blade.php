...
<!--End side menu component-->
    ...
    <!---end of navbar !-->
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            <thead >
            <tr >
                <th style="background: lightseagreen; color: white;" >الشركة</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                    <div class="modal-header" dir="ltr">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 32%;margin-top: 6%"><i class="fas fa-shipping-fast fa-2x" style="padding-right: 10px"></i><span class="add_word">اضافة</span> شركة شحن  </h5>
...
<script >
    $(document).ready(function() {
       ...
       /* var temp=$(".grid .row:last");
        ...
        x=$("<button id='modal_button' data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-shipping-fast fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة شركة شحن</span></i></button>");
