        ...
        <div class="tab-pane fade show active " id="ship-details" role="tabpanel" aria-labelledby="nav-home-tab">
            <table class="table table-bordered table-striped" style="background: white; width:90%; margin-right: 5%; margin-top:5%">
                ...
                <tr>
                    ...
                    <td><select style="background: none; border:none;">
        ...
        <div class="tab-pane fade" id="ship-orders" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="exporters-main-container col-12" style="">
                ...
                <table id="example" dir="ltr" class="ui celled table table-fixed" style="text-align: center" dir="rtl"   >
                    ...
                    <tr class="firstrow">
                        <th style="background: lightseagreen; color: white;" >تحصيل</th>
                        <th style="background: lightseagreen; color: white;" >المستخدم</th>
                        <th style="background: lightseagreen; color: white;">حالة</th>
                        <th  style="background: lightseagreen; color: white;">اصناف</th>
                        <th style="background: lightseagreen; color: white;">السعر</th>
                        <th style="background: lightseagreen; color: white;">البوليصة</th>
                ...
                <tr id="{{$order->id}}"  style="font-weight: 700">
                    ...
                    <td class="number"><a style="font-weight: 700" target="_blank" class="link" href="">{{$order->id}}</a></td>
        ...
        <div class="tab-pane fade " id="ship-payments" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <table id="payments" class="ui celled table" style="text-align: center" dir="rtl"    >
                ...
                <tr >
                    ...
                    <th style="background: lightseagreen; color: white;" >تاريخ</th>
                    <th style="background: lightseagreen; color: white;">بيان</th>
                    <th style="background: lightseagreen; color: white;">وسيلة الدفع</th>
                 
                    <th style="background: lightseagreen; color: white;">اجمالي</th>
        ...
        <div class="tab-pane fade " id="ship-districts" role="tabpanel" aria-labelledby="nav-home-tab">
            <table id="districts" class="ui celled table" style="text-align: center" dir="rtl"    >
                ...
                <tr >
                    ...
                    <th style="background: lightseagreen; color: white;" >المنطقة</th>
                    <th style="background: lightseagreen; color: white;">المبلغ</th>
                    <th style="background: lightseagreen; color: white;">حفظ</th>
              ...
              @foreach (\App\Ship::find($ship_id)->shipdistricts as $shipdistrict)
                <tr>
                    ...
                    <form method="post" action="{{route("ship-districts.update",$shipdistrict->id)}}">
                        ...
                        <td class="cost">  <input name="cost" value="{{$shipdistrict->cost}}"></td>

                        <td><button class="transparent_button" ><i class="fas fa-check-circle"></i></button></td>
      ...
      <div class="modal fade" id="districtsModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  >
          <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 45%">
              <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                  <div class="modal-header" dir="ltr">
                      <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 37%;margin-top: 6%"> <i class="fas fa-map-marked-alt fa-2x" style="padding-right: 10px"></i> <span>اضافة منطقة شحن </span> </h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true" style="font-size: 30px">&times;</span>
                      </button>
                  </div>
                  <div class="modal-body" style="height: auto">
                    <form action="{{route("ship-districts.store")}}" method="post">
                        @csrf
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                    <div class="modal-header" dir="ltr">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 37%;margin-top: 6%"><i class="fas fa-user fa-2x" style="padding-right: 10px"></i> تحصيل مبلغ    </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true" style="font-size: 30px">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" style="height: auto">
                        <form id="form" method="post" action="{{route("ship-payments.store","")}}">
                            @csrf
                            <input name="ship_id" value="{{$ship_id}}" class="d-none">
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input dir="rtl" type="number" min="1" id="amount"   name="amount" class="form-control" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            <div class="form-group row" style="width: 100%">
                                <label class="sr-only" >Username</label>
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input dir="rtl" type="date" min="1" id="date"  name="date" class="form-control" aria-describedby="basic-addon1">
                            ...
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input dir="rtl" type="text" id="method"  name="method" class="form-control" aria-describedby="basic-addon1">
                            ...
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input dir="rtl" type="text" id="description"  name="description" class="form-control" aria-describedby="basic-addon1">
         ...
         $(".ui .row:first .eight:first ").html(x);*/
           ...
           /* var temp=$(".grid .row:last");
            ...
            $("#payments_filter").attr("dir","rtl");
             ...
             x=$("<button id='modal_button' data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-hand-holding-usd fa-2x' ><span style='padding: 14px;font-size: 17px'> تحصيل مبلغ</span></i></button>");
            ...
            $("#districts_filter").attr("dir","rtl");
             ...
             x=$("<button id='districts_modal_button' data-target='#districtsModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-map-marked-alt fa-2x' ><span style='padding: 14px;font-size: 17px'>  تسجيل منطقة شحن </span></i></button>");
