...
<table id="last" style="display: none">
    <tr>
        <td class="co-2 name"></td>
        <td class="co-2 code"></td>
        <td class="co-1 size"></td>
        <td class="co-2 max_restored_quantity"></td>
        <td class="co-2 price"></td>
        <td class="co-1 restore" data-route="" data-id="" ><i style="border: none" class="fas fa-undo fa-2x"></i></td>
        <td class="co-1" data-id="" ><a class="replace_link" style="border: none" href="{{route("replacement_create","X")}}">استبدال</a></td>
