...
<div class="wrapper d-flex align-items-stretch" dir="rtl">
    <div class="hidden_phone form-group row" style="width: 100%; display: none" id="hidden_phone">
        ...
        <div class="input-group mb-2 mr-sm-2">
            ...
            <input  name="phone" type="text" class="form-control" placeholder="ادخل رقم المندوب">
        </div>
    </div>
    <div class="hidden_address form-group row" style="width: 100%;display: none" id="hidden_address">
        ...
        <div class="input-group mb-2 mr-sm-2">
            ...
            <input name="address[]" id="" type="text" class="form-control"  placeholder="ادخل عنوان المندوب">
        </div>
    </div>
    <!--============================================-->
    <!--============================================-->
...
<!--End side menu component-->
    ...
    <div style="width: 82%" id="main_div">
        ...
        @section('content')
            ...
            <li class="breadcrumb-item active" aria-current="page" ><a href="{{route("deliveryman.index")}}"> مناديب الشحن </a></li>
    ...
    <!---end of navbar !-->
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            <thead >
            <tr >
                <th style="background: lightseagreen; color: white;" >المندوب</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="    border: 4px solid gainsboro;  border-radius: 2.24rem;">
                    <div class="modal-header" dir="ltr">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="margin-left: 32%;margin-top: 6%"><i class="fas fa-user fa-2x" style="padding-right: 10px"></i> <span class="add_word">اضافة</span> مندوب شحن  </h5>
                    ...
                    <div class="modal-body" style="height: auto">
                        <form id="modal_form" action="{{route("ships.store")}}" method="post">
                            @csrf
                            <input id="type" name="type" value="person"  class="d-none"> 
                            <div class="form-group row" style="width: 100%">
                                <label class="sr-only" >Username</label>
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text" style="font-weight: 700">اسم المندوب</div>
                                    </div>
                                    <input name="name" id="name" type="text" class="form-control all"  placeholder="ادخل اسم المندوب">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="width: 100%">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input name="address" id="address" type="text" class="form-control all"  placeholder="ادخل عنوان المندوب">
                                </div>
                            </div>
                            <div class="form-group row" style="width: 100%">
                                <label class="sr-only" >Username</label>
...
<script >
    $(document).ready(function() {
       ...
       /* var temp=$(".grid .row:last");
        ...
        x=$("<button id='modal_button' data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-shipping-fast fa-2x' ><span style='padding: 14px;font-size: 17px'>اضافة مندوب شحن</span></i></button>");
