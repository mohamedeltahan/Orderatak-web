    ...
    <div class="exports_cases" style="width: 80%; display: inline-flex; margin-left: 10%; padding:15px" >
            ...
            <form style="display: block" method="post" action="{{route("caches.store")}}">
                ...
                <div class="line" style="display: flex;width: 90%">
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        ...
                        <select class="all" style="border: 1px solid lightseagreen;border-radius: 10px;width: 80%; height: 35px;" name="type">
                    ...
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        ...
                        <input class="all" name="client" style="border: 1px solid lightseagreen;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 57%;"> رقم الفاتورة:</label>
                        <input class="all" name="receipt_id" style="border: 1px solid lightseagreen;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                </div>
                ...
                <div class="line" style="display: flex;width: 90%">
                    ...
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        ...
                        <input class="all" name="amount" style="border: 1px solid lightseagreen;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 55%;"> التاريخ:</label>
                        <input class="all" name="date"  type="date" style=" text-align:right;border: 1px solid lightseagreen;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                    <div style="margin-top: 25px; margin-right: 10px;width: 33%;">
                        <label style="display: block;margin-left: 55%;"> ملاحظة:</label>
                        <input class="all" name="details" style="border: 1px solid lightseagreen;border-radius: 10px;width: 80%;height: 35px;">
                    </div>
                </div>
                <div class="line" style="display: flex;width: 90%">
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            ...
            <tr >
                ...
                <th style="background: lightseagreen; color: white;" >اسم المستخدم</th>
                <th style="background: lightseagreen; color: white;">رقم الفاتورة / شيك</th>
                <th style="background: lightseagreen; color: white;">نوع العمليه</th>
                <th style="background: lightseagreen; color: white;">اسم المستلم</th>
                <th style="background: lightseagreen; color: white;">التاريخ</th>
                <th style="background: lightseagreen; color: white;">المبلغ</th>
                <th style="background: lightseagreen; color: white;">ملاحظة</th>
