...
margin-left: 35%">
        ...
        <table id="example" class="ui celled table" style="text-align: center" dir="rtl"   >
            <thead >
            <tr >
                <th style="background: lightseagreen; color: white;" >   تاريخ التسجيل</th>
                <th style="background: lightseagreen; color: white;" > تاريخ الفاتورة</th>
                <th style="background: lightseagreen; color: white;">بيان</th>
                <th style="background: lightseagreen; color: white;">وسيلة الدفع</th>
                <th style="background: lightseagreen; color: white;">ارقم الفاتورة</th>
                <th style="background: lightseagreen; color: white;">دائن</th>
                <th style="background: lightseagreen; color: white;">مدين</th>
    ...
    $(document).ready(function() {
       ...
       /* var temp=$(".grid .row:last");
        ...
        $("#example_filter").attr("dir","rtl");
         ...
         x=$("<button id='modal_button' data-target='#exampleModalCenter' data-toggle='modal' class='btn btn-primary' style='border: none; background: lightseagreen;border-radius: 1.24rem;'><i class='fas fa-money-check-alt fa-2x' ><span style='padding: 14px;font-size: 17px'> تسجيل معاملة </span></i></button>");
